...
;; Based on Machine 07
;; ===================
;; For Ex 11 Part C, have separate stack for each register.
;;   - add stack to register in make-register
;;   - add make-save and make-register to use register's stack
;;   - remove references to orignal stack
