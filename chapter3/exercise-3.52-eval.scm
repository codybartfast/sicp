...
;; This is the eval/exec implementation used for ex 4.24 with extra
;; primitives to support ex 3.52
...
(#%require "../chapter4/ea-underlying-apply.scm")
(#%require "../chapter4/ea-analyzers.scm")
